...
Any affected character that witnesses the performance or artwork is deeply affected, raising their Attitude by one point. This does not stack with other magical Attitude bonuses.`,
  ...
  },
  {
    title: 'HEARTFELT EXPRESSION',
	purview: 'ARTISTRY',
	mechanics: `This Attitude shift lasts even after you reclaim the Legend from this Boon. However, once you do so, your painting, music, or other artwork won’t inspire any more characters with emotion. Seeing multiple pieces of art made with this Boon doesn’t stack their Attitude boosts.`,
	clash: 'Presence + Legend vs. Composure + Legend',
	isContinued: true,
=======
Any affected character that witnesses the performance or artwork is deeply affected, raising their Attitude by one point. This does not stack with other magical Attitude bonuses.
...
<b>Senses</b>: Choose a specific circumstance in which the animal’s senses give an advantage — an eagle’s eyes can see clearly from far away, a bat can echolocate in total darkness, while a dog can track by scent for miles. You have Enhancement 3 on sense-based rolls where that advantage applies.`,
  ...
  },
  {
    title: 'ANIMAL ASPECT',
	purview: 'BEASTS',
	mechanics: `<b>Other</b>: Pick a miscellaneous trait, like an octopus’s camouflage, an anglerfish’s bioluminescence, etc. You either have Enhancement 2 on actions that trait benefits, or ignore up to 3 points of Complication it negates, whichever best represents the chosen trait.`,
	clash: '',
	isContinued: true,
  },
  {
...
A blessed character may use their beauty once per scene to add Enhancement 2 on any roll made with a Social Attribute. This Condition resolves once its benefit has been applied a total of your (Legend + 1) times.`,
  ...
  },
  {
    title: 'DRAW BACK THE MASK',
	purview: 'BEAUTY',
	mechanics: `A cursed character suffers a +2 Complication on all Social rolls where their distorted appearance is a disadvantage. This Condition can be resolved by making a sincere and heartfelt apology to someone the target has wronged in a significant way, or with curse-breaking magic.`,
	isContinued: true,
  },
  {
...
This is a Condition, with precise effects that depend on that character’s personality and their relation to the deceased. A political activist who feels responsible for assassinating an opposition party candidate might have a hard time not bragging about it, while someone who thinks they let the love of their life die will be devastated.`,
  ...
  },
  {
    title: 'YOUR FAULT',
	purview: 'DEATH',
	mechanics: `As a default, the Condition increases the difficulty of all actions that character takes by +2, except actions that have the potential to harm them or otherwise traumatically expiate their guilt.
...
A non-trivial character who wins the Clash of Wills can see through the illusion.`,
  ...
  },
  {
    title: 'EPHEMERA',
	purview: 'DECEPTION',
	mechanics: `Attempts to touch or physically interact with an illusion go right through it, letting anyone who sees this recognize it as unreal in the absence of extraordinary circumstances.`,
	clash: 'Manipulation + Legend vs. Cunning + Legend',
	isContinued: true,
  },
  {
...
They grow cold-hearted, almost emotionless. Whatever they were...`,
  ...
  },
  {
    title: 'COOLER HEADS',
	purview: 'FROST',
	mechanics: `...doing, they stop, and won’t return to it for the rest of the scene — they’ll walk away from brawls, take a moment to reconsider whether they should be having an emotional argument, take the time to think their plans through more thoroughly, or similar. They can still defend themselves if others try to harm them, but will not initiate any kind of hostilities.`,
	clash: 'Composure + Legend vs. Presence + Legend',
	isContinued: true,
=======
    purview: 'FROST',
...
If you use this Boon on yourself, you gain a bonus on rolls with a specific Skill depending on your apparent age:`,
  ...
  },
  {
    title: 'THREE-FACED MOON',
	purview: 'MOON',
	mechanics: `<b>Youth:</b> As a young child, you seem full of innocence, adding Enhancement 2 on Empathy rolls.
<b>Adult:</b> As a mother or father, you provide comfort, adding Enhancement 2 on Medicine rolls.
<b>Elder:</b> You know the secrets of your people, adding Enhancement 2 on Occult rolls.`,
	isContinued: true,
=======
    purview: 'MOON',
    cost: 'Imbue 1 Legend',
...
<<<<<<< HEAD
  ...
  },
  {
    title: 'IRRESISTIBLE IMPULSE',
	purview: 'PASSION',
	mechanics: `Other characters gain Enhancement 3 on rolls to detect the inflamed emotion.
...
Regardless of the form it takes, money conjured with this Boon wants to be spent — any that remains in your possession once the session ends vanishes.`,
  ...
  },
  {
    title: 'BLESSED WEALTH',
	purview: 'PROSPERITY',
	mechanics: `The money retains your blessing once it has been given away, giving a mortal Enhancement 3 on a single roll to run a business successfully or maintain a comfortable home and lifestyle (above and beyond the usual benefits of having money to spend).
...
Once the action is complete, you disappear in a burst of starlight and instantly reappear anywhere in the World, regardless of distance.`,
  ...
  },
  {
    title: 'STARRY PATH',
	purview: 'STARS',
	mechanics: `You can bring up to (Legend) additional willing characters with you when you teleport. Other Scions and mortals Fatebound to you don’t count towards this limit.
...
`,
  ...
  },
  {
    title: 'KNOW THE BATTLEFIELD',
	purview: 'WAR',
	mechanics: `Following the Storyguide’s answer grants Enhancement 3 on applicable rolls.
...
You predict a specific triumph or downfall the character will face, and impose a Condition that represents this destiny on them. If an action is likely to bring about the foretold fate, the Condition provides Enhancement 2. Actions that struggle against this destiny have their Difficulty increased by 1, or by 2 if they would make it outright impossible for it to come to fruition.`,
  ...
  },
  {
	...
	duration: 'Condition',
	subject: 'One character',
	mechanics: `These effects cut both ways — a blessing might make it more difficult for a warrior to undertake a plan if it would lead to his defeat, while a curse might give a foe an Enhancement on actions that lead to their downfall.
...
<<<<<<< HEAD
  ...
  },
  {
    title: 'TONGUE OF THE BARD',
	purview: 'GEASA',
	mechanics: `In order to receive the answer, you must speak it aloud. 
	
	The Storyguide gives you an answer in the form of a speech or poem that you can perform.
	
	This information grants Enhancement 3 to any actions that benefit from it.
	
	Discovering that a good-looking stranger in a bar is descended from the Theoi would give an Enhancement on a roll to work out which of the Gods he is descended from, but not on a roll to impress him with a pick-up line.
